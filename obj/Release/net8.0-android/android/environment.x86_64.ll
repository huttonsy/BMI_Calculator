...
@dso_cache = dso_local local_unnamed_addr global [480 x %struct.DSOCacheEntry] [
	...
	%struct.DSOCacheEntry {
		i64 57096162463343377, ; hash 0xcad8a841aa6311, from name: BMICalculatorMobileApp
		i8 0, ; bool ignore
		ptr @.DSOCacheEntry.7_name, ; name: libaot-BMICalculatorMobileApp.dll.so
		ptr null; void* handle (0x0)
	}, ; 1
	%struct.DSOCacheEntry {
	...
	%struct.DSOCacheEntry {
		i64 8399837316684132772, ; hash 0x74923789080731a4, from name: libaot-BMICalculatorMobileApp
		i8 0, ; bool ignore
		ptr @.DSOCacheEntry.7_name, ; name: libaot-BMICalculatorMobileApp.dll.so
		ptr null; void* handle (0x0)
	}, ; 202
	...
	%struct.DSOCacheEntry {
		i64 9301083318194188102, ; hash 0x811415ffa746af46, from name: libaot-BMICalculatorMobileApp.dll.so
		i8 0, ; bool ignore
		ptr @.DSOCacheEntry.7_name, ; name: libaot-BMICalculatorMobileApp.dll.so
		ptr null; void* handle (0x0)
	}, ; 234
	...
	%struct.DSOCacheEntry {
		i64 12986250881404232010, ; hash 0xb4386e5f5e33e14a, from name: BMICalculatorMobileApp.dll.so
		i8 0, ; bool ignore
		ptr @.DSOCacheEntry.7_name, ; name: libaot-BMICalculatorMobileApp.dll.so
		ptr null; void* handle (0x0)
	}, ; 332
	...
	%struct.DSOCacheEntry {
		i64 16636368624018215798, ; hash 0xe6e0411ecb0f5376, from name: aot-BMICalculatorMobileApp
		i8 0, ; bool ignore
		ptr @.DSOCacheEntry.7_name, ; name: libaot-BMICalculatorMobileApp.dll.so
		ptr null; void* handle (0x0)
	}, ; 430
	...
	%struct.DSOCacheEntry {
		i64 18403892756984747277, ; hash 0xff67c2f45875d50d, from name: aot-BMICalculatorMobileApp.dll.so
		i8 0, ; bool ignore
		ptr @.DSOCacheEntry.7_name, ; name: libaot-BMICalculatorMobileApp.dll.so
		ptr null; void* handle (0x0)
	}, ; 478
...
@.env.3 = private unnamed_addr constant [37 x i8] c"57c7c197-c26f-4e85-a71f-6a9fef3993d3\00", align 16
...
;ApplicationConfig
@.ApplicationConfig.0_android_package_name = private unnamed_addr constant [39 x i8] c"com.companyname.bmicalculatormobileapp\00", align 16
...
@.DSOCacheEntry.7_name = private unnamed_addr constant [37 x i8] c"libaot-BMICalculatorMobileApp.dll.so\00", align 16
